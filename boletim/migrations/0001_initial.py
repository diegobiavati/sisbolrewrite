    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('slug', models.SlugField()),
                ('biDeReferencia', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='boletim.boletim')),
                ('tipoPublicacao', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='boletim.tipobi')),
            ],
        ),
    ]
