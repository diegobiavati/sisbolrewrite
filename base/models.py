'''
Modelos padrões do sistema
'''
import datetime
from django.db import models

def selecao_anos():
    ''' Função que retorna os últimos 10 anos e retorna o ano atual e o próximo '''
...
class OrganizacaoMilitar(models.Model):
    ''' Classe que define os dados da Organização Militar '''
...
class Pessoa(models.Model):
    ''' Classe que define as Pessoas que podem ter matérias publicadas '''
    SEXOS = [
        ("F", "Feminino"),
        ("M", "Masculino"),
